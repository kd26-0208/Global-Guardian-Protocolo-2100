...
const introTextSequence = [
    ...
    "Te hemos elegido a ti. No porque seas un político, sino porque tienes la capacidad de ver la Tierra como un solo organismo. Tu objetivo es simple pero casi imposible: Estabilizar estos tres pilares y guiar a la humanidad hasta el año 2060.\n\n",
...
function init() {
    ...
    if(btnTutorialSkip) btnTutorialSkip.addEventListener('click', endTutorial);
