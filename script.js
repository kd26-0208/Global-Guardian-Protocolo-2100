...
function init() {
    ...
    const btnPracticeYes = document.getElementById('btn-practice-yes');
    const btnPracticeNo = document.getElementById('btn-practice-no');

    if (btnPracticeYes) {
        btnPracticeYes.addEventListener('click', startPracticeRound);
    }
    if (btnPracticeNo) {
        btnPracticeNo.addEventListener('click', () => {
